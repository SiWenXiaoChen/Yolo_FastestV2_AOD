...
parser.add_argument('--data', type=str, default='data/traffic_dust.data',
                    help='Specify training profile *.data')
parser.add_argument('--weights', type=str, default='weights/traffic_dust-250-epoch-0.837009ap-model.pth',
