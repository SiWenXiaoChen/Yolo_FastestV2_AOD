...
parser.add_argument('--weights', type=str, default='weights/traffic-50-epoch-0.840266ap-model.pth',
                    help='The path of the .pth model to be transformed')
parser.add_argument('--img', type=str, default='img/017.jpg', help='The path of test image')
parser.add_argument('--vid', type=str, default='Lar/Lara_UrbSeq1_CAOR_v3_7_HR.avi', help='The path of test image')
